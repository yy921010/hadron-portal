...
class ChannelDetail extends Component<
  { loading: boolean; channelAndChannelDetail: AdvancedProfileData; dispatch: Dispatch<any> },
  ChannelDetailState
> {
  public state: ChannelDetailState = {
    operationKey: 'tab1',
    tabActiveKey: 'detail',
  };
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'channelAndChannelDetail/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { channelAndChannelDetail, loading } = this.props;
    const { advancedOperation1, advancedOperation2, advancedOperation3 } = channelAndChannelDetail;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(
  ({
    channelAndChannelDetail,
    loading,
  }: {
    channelAndChannelDetail: AdvancedProfileData;
    loading: {
      effects: { [key: string]: boolean };
    };
  }) => ({
    channelAndChannelDetail,
    loading: loading.effects['channelAndChannelDetail/fetchAdvanced'],
  }),
)(ChannelDetail);
